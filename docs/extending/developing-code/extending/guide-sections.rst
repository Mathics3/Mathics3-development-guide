...
By default, the ordering of sections in the documentation is determined by the order of lexical order of the Python module names. Somethings this is not what is wanted. Therefore to change this, module variable ``sort_order`` can be set to specify the order used in sorting.
